...
## 10. Código completo utilizado

Se presenta el código completo utilizado para ejecutar la práctica:
...
// Save and load model
// Estas líneas se comentaron porque en Windows generaban error relacionado con HADOOP_HOME / winutils.exe.
